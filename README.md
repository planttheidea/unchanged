...
A tiny (~2kb minified+gzipped), [fast](https://github.com/planttheidea/unchanged/blob/master/benchmark_results.csv), unopinionated immutable handler for updating JS objects and arrays.
